...
Func MainGUI()
	ConsoleWrite('@@ (21) :(' & @MIN & ':' & @SEC & ') MainGUI()' & @CR) ;### Function Trace
	$TimeOut = 5000
...
Func AboutGUI()
	ConsoleWrite('@@ (97) :(' & @MIN & ':' & @SEC & ') AboutGUI()' & @CR) ;### Function Trace
...
Func OptionGUI()
	ConsoleWrite('@@ (146) :(' & @MIN & ':' & @SEC & ') OptionGUI()' & @CR) ;### Function Trace
...
Func Button1()
	ConsoleWrite('@@ (168) :(' & @MIN & ':' & @SEC & ') Button1()' & @CR) ;### Function Trace
	$InfoVal = 0
...
Func GMStat()
	ConsoleWrite('@@ (202) :(' & @MIN & ':' & @SEC & ') GMStat()' & @CR) ;### Function Trace
	$InfoVal = 1
...
Func TSStat()
	ConsoleWrite('@@ (249) :(' & @MIN & ':' & @SEC & ') TSStat()' & @CR) ;### Function Trace
	$InfoVal = 2
	GUICtrlSetData($Label5, "Checking...")
	Switch $TimeVal
		Case 0
...
Func WSStat()
	ConsoleWrite('@@ (296) :(' & @MIN & ':' & @SEC & ') WSStat()' & @CR) ;### Function Trace
	$InfoVal = 3
	GUICtrlSetData($Label5, "Checking...")
	Switch $TimeVal
		Case 0
...
Func CustStat()
	ConsoleWrite('@@ (343) :(' & @MIN & ':' & @SEC & ') CustStat()' & @CR) ;### Function Trace
	$InfoVal = 4
	GUICtrlSetData($Label5, "Checking...")
...
Func CustIPStat()
	ConsoleWrite('@@ (392) :(' & @MIN & ':' & @SEC & ') CustIPStat()' & @CR) ;### Function Trace
	$InfoVal = 5
	GUICtrlSetData($Label5, "Checking...")
...
Func LogGSTrue()
	ConsoleWrite('@@ (440) :(' & @MIN & ':' & @SEC & ') LogGSTrue()' & @CR) ;### Function Trace
...
Func LogGSFalse()
	ConsoleWrite('@@ (446) :(' & @MIN & ':' & @SEC & ') LogGSFalse()' & @CR) ;### Function Trace
	$LogDir = FileReadLine(@ProgramFilesDir & "\StatCheckSettings.txt", 1)
...
Func LogTSTrue()
	ConsoleWrite('@@ (452) :(' & @MIN & ':' & @SEC & ') LogTSTrue()' & @CR) ;### Function Trace
	$LogDir = FileReadLine(@ProgramFilesDir & "\StatCheckSettings.txt", 1)
...
Func LogTSFalse()
	ConsoleWrite('@@ (458) :(' & @MIN & ':' & @SEC & ') LogTSFalse()' & @CR) ;### Function Trace
	$LogDir = FileReadLine(@ProgramFilesDir & "\StatCheckSettings.txt", 1)
...
Func LogWSTrue()
	ConsoleWrite('@@ (464) :(' & @MIN & ':' & @SEC & ') LogWSTrue()' & @CR) ;### Function Trace
	$LogDir = FileReadLine(@ProgramFilesDir & "\StatCheckSettings.txt", 1)
...
Func LogWSFalse()
	ConsoleWrite('@@ (470) :(' & @MIN & ':' & @SEC & ') LogWSFalse()' & @CR) ;### Function Trace
	$LogDir = FileReadLine(@ProgramFilesDir & "\StatCheckSettings.txt", 1)
...
Func LogURLTrue()
	ConsoleWrite('@@ (476) :(' & @MIN & ':' & @SEC & ') LogURLTrue()' & @CR) ;### Function Trace
	$LogDir = FileReadLine(@ProgramFilesDir & "\StatCheckSettings.txt", 1)
...
Func LogURLFalse()
	ConsoleWrite('@@ (482) :(' & @MIN & ':' & @SEC & ') LogURLFalse()' & @CR) ;### Function Trace
	$LogDir = FileReadLine(@ProgramFilesDir & "\StatCheckSettings.txt", 1)
...
Func LogIPTrue()
	ConsoleWrite('@@ (488) :(' & @MIN & ':' & @SEC & ') LogIPTrue()' & @CR) ;### Function Trace
	$LogDir = FileReadLine(@ProgramFilesDir & "\StatCheckSettings.txt", 1)
...
Func LogIPFalse()
	ConsoleWrite('@@ (494) :(' & @MIN & ':' & @SEC & ') LogIPFalse()' & @CR) ;### Function Trace
	$LogDir = FileReadLine(@ProgramFilesDir & "\StatCheckSettings.txt", 1)
...
Func ClearLabels()
	ConsoleWrite('@@ (500) :(' & @MIN & ':' & @SEC & ') ClearLabels()' & @CR) ;### Function Trace
	GUICtrlSetData($Label5, "")
	GUICtrlSetData($Label9, "")
	GUICtrlSetState($Button6, $GUI_HIDE)
	GUICtrlSetState($Button5, $GUI_HIDE)
...
Func MoreInfo()
	ConsoleWrite('@@ (508) :(' & @MIN & ':' & @SEC & ') MoreInfo()' & @CR) ;### Function Trace
	TCPStartup()
	Switch $InfoVal
		Case 1 ;;GMStat()
